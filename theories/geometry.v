(* geometry.v -- Huzita O1-O7, folds, constructibility and enumeration, the Gaussian-period tower, and the regular n-gon iff.  Auto-generated by _split/tier_plan.py from origami_proofs.v. *)
...
(* cossum (origami_proofs) as an rsum over an index range *)
